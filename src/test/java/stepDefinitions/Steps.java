...
public class Steps {
	...
	@Then("^Status Code Must Be \"([^\"]*)\"$")
	public void status_Code_Must_Be(int arg1) throws Throwable {
		System.out.println("response status code after getting list of code:::: "+response.getStatusCode());
	}
}